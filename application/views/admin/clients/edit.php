<div id="main_content" class="clearfix">
    ...
    <div id="edit_content" class="clearfix left">
        ...
        <? 
            ...
            $website_data = array( 'name' => 'website', 'id' => 'website', 'value' => row_value('website') );
            $description_data = array( 'name' => 'description', 'id' => 'content', 'value' => description() );
        ?>
        ...
        <label>Website</label>
        <?=form_input( $website_data, '' )?>

        <label>Description</label>
        <?=form_input( $description_data, '' );?>
