...
function confirm_delete_entry() 
{
   ...
   var base = getBaseURL();
   var posturl = ( base + "/features/remove/" + did );
   ...
   chi_confirm( 'Are you sure that you want to delete \''+ $(this).parent().find("div.edit_long a").html() +'\'? This cannot be undone.', 'Delete Feature', buttons );
}
...
$(document).ready( function() {
	$('.d_features').click( confirm_delete_entry );
});
