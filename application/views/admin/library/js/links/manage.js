...
function confirm_delete_entry() 
{
   ...
   var base = getBaseURL();
   var posturl = ( base + "/links/remove/" + did );
   ...
   chi_confirm( 'Are you sure that you want to delete \''+ $(this).parent().find("div.edit_long a").html() +'\'? This cannot be undone.', 'Delete Link', buttons );
}
...
$(document).ready( function() {
	$('.d_links').click( confirm_delete_entry );
});
