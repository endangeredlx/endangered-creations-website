...
function confirm_delete_entry() 
{
   ...
   var base = getBaseURL();
   var posturl = ( base + "/music/remove_song/" + did );
   ...
   var buttons = {
      ...
      option2  :  {
         id          : 'confirm_button',
         title       : 'Delete',
         onConfirm   : 'delete_music_entry',
         class       : 'light_blue_button',
         args        : myArgs
      }
   }; 
   chi_confirm( 'Are you sure that you want to delete \''+ $(this).parent().find("div.edit_mid a").html() +'\'? This cannot be undone.', 'Delete Music', buttons );
}

function delete_music_entry( obj ) 
{
   $.ajax({
		url: obj.url,
		type: 'POST',
