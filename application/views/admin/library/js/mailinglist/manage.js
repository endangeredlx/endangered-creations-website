...
function confirm_delete_entry() 
{
   ...
   var base = getBaseURL();
   var posturl = ( base + "/mailinglist/remove/" + did );
   ...
   chi_confirm( 'Are you sure that you want to delete \''+ $(this).parent().find("div.edit_long a").html() +'\'? This cannot be undone.', 'Delete Contact', buttons );
}
...
$(document).ready( function() {
	$('.d_mailinglist').click( confirm_delete_entry );
});
