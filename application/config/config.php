...
|
*/
$config['base_url']	= "http://endangeredcreations.com/";
...
|
*/
$config['encryption_key'] = "autOSPYyhSH6nBEeBTWAXvLmKHDwqKVH";
...
|
*/
$config['sess_cookie_name']		= 'chi_session';
...
| 
*/  
$config['no_reply_email'] = "{no_reply}";  
