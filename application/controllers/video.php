...
class Video extends CI_Controller
{
    ...
    var $primary_table          = 'video_playlists';
    var $secondary_singular     = 'video';
    var $secondary_plural       = 'videos';
    var $secondary_table        = 'video_videos';
    var $tertiary_table         = 'video_records';
    // }}}
    ...
    public function edit()
    { 
        header( 'Location: ' . base_url() . 'video/manage/videos' );
    }
    // }}}
    ...
    public function edit_playlist( $success = false, $warning = false, $error = false )
    {
        ...
        // Grab Video Decorator
        require( APPPATH . 'libraries/ChiVideo' . EXT );

        // Main page configuration.
        $ChiQL =& $this->ChiRecords;
        $ChiVideo = new ChiVideo( $ChiQL );
        $Options =& $this->ChiOptions;
